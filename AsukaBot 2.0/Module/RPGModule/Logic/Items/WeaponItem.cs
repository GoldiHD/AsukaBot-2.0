...
namespace AsukaBot_2._0.Module.RPGModule.Logic.Items
{
    public class WeaponItem : BaseItem
    {
        ...
        public WeaponItem(string name, string itemdescribe, int damge, PhyDamgeType mydamgephytype, MagicDamgeType magictype, int price, bool buyable, int itemvalue, bool questItem, bool craftable, List<ItemType> itemDefine, List<CraftingItemInItem> craftingItems, Rarity rare)
        {
            Name = name;
