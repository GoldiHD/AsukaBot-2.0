...
namespace AsukaBot_2._0.Module.StandardCommands
{
    public class StandardCommandModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task Shutdown()
        {
            ...
            {
                await Context.Channel.SendMessageAsync("Yes, master");
                //disconnect
                Environment.Exit(0);
            }
            else
        ...
        [Command("back")]
        public async Task ImBackBiches()
        {
            await ReplyAsync("I'm back bitches");
        }
    }
}
