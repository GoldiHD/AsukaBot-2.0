...
namespace AsukaBot_2._0.Module.Games
{
    public class BasicGameModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task RollDice([Remainder]string input)
        {
            ...
            {
                await ReplyAsync("[ERROR], doesn't contain all the parameters, correct way would be \"!dice 1d20\"");
            }
